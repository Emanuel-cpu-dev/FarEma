...
private String purchaser;
    ...
    public Purchases(int id, int code, String product_name, double purchase_amount, double purchase_price, double purchase_subtotal, Double total, String created, String supplier_name_product, String purchaser) {
        this.id = id;
        this.code = code;
