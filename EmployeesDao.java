...
public class EmployeesDao {
    ...
    //Variables p enviar datos entre interfaces
            ...
            //almacenamos todo menos la password
    private String value;
            ...
            public Employees loginQuery(String user, String password){
                //aca escribimos la variable para que nos mande la info del logueo
                String query = "SELECT *FROM employees WHERE username = ? AND password = ?"; //traeme todos (*) los campos
            ...
            public boolean registerEmployeeQuery (Employees employee){
                var query = "INSERT INTO employees(id, full_name, username, address,telephone, email, password, rol, created,"
                        + "updated) VALUES(?,?,?,?,?,?,?,?,?,?)";
            ...
            //listar empleados
            public List listEmployeesQuery(String values){
                List<Employees> list_employees = new ArrayList();
                String query = "SELECT *FROM employees ORDER BY rol ASC";//CONSULTA Y ORDENADO
                //String value = null;
 ...
 public boolean updateEmployeeQuery (Employees employee){
                var query = "UPDATE employees SET full_name=?, username=?, address=?,telephone=?, email=?,  rol=?, UPDATED=?"
                + "WHERE id = ?";
                ...
                JOptionPane.showMessageDialog(null, "Error al modificar datos del empleado" +e);
                return false;
            }
       }
 
 //METODO P ELIMINAR EMPLEADO
 ...
 public boolean updateEmployeePassword(Employees employee){
     ...
     try{
         ...
         JOptionPane.showMessageDialog(null, "Ha ocurrido err al mod contraseña" + e);
         return false;
     }
